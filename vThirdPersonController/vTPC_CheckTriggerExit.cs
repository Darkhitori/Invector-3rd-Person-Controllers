...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Call this in OnTriggerExit to check if exit of triggerActions ")]
	public class vTPC_CheckTriggerExit : FsmStateAction
	{
		[RequiredField]
		...
		void DoTheMagic()
		{
			...
			theScript.CheckTriggerExit(vOther);
			if (sendEvent == null)
			{
				return;
			}
