...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Leave (Destroy) current equiped item of specific area ")]
	public class vIM_LeaveCurrentEquipedItem : FsmStateAction
	{
		[RequiredField]
		...
		void DoTheMagic()
		{
			...
			theScript.LeaveCurrentEquipedItem(indexOfArea.Value, immediate.Value);
