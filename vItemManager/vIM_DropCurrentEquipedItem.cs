...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Drop current equiped item of specific area ")]
	public class vIM_DropCurrentEquipedItem : FsmStateAction
	{
		[RequiredField]
		...
		void DoTheMagic()
		{
			...
			theScript.DropCurrentEquipedItem(indexOfArea.Value, immediate.Value);
